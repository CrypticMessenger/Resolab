    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                className={`absolute ${isMinimized ? 'bottom-24 right-4' : 'bottom-32 left-1/2 -translate-x-1/2'} bg-black/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden flex flex-col z-[100] transition-all duration-300 pointer-events-auto`}
            >
                {/* Header */}
